#  A shell script to use if you want different reports on Mondays
...
echo "List of sev 7 or greater CVEs created or updated over the weekend, since $weekend with CPE "
